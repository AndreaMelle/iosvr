#ifndef _CARBOARD_METAL_MATH_TRANSFORMS_H_
#define _CARBOARD_METAL_MATH_TRANSFORMS_H_
...
namespace CM
{
    ...
    simd::float4x4 fromGLKMatrix4(const GLKMatrix4& matrix);
    GLKMatrix4 toGLKMatrix4(const simd::float4x4& matrix);
    
    simd::float4x4 identity();
    simd::float4x4 swapHandness(const simd::float4x4& matrix);
