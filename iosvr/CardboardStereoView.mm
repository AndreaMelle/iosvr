//
//  CardboardStereoView.m
//
//  Created by Ricardo Sánchez-Sáez on 01/02/2015.
//

#import "CardboardStereoView.h"
...
@implementation CardboardStereoView
...
- (void)setupGLProgram
{
    ...
    hfgl::Shader::CompileShader(&vertexShader, GL_VERTEX_SHADER, vertexShaderSource);
    if (vertexShader == 0) { return; }
    
    GLuint pixelShader = 0;
    hfgl::Shader::CompileShader(&pixelShader, GL_FRAGMENT_SHADER, fragmentShaderSource);
    ...
    hfgl::CheckGlErrors();
#endif
    hfgl::Shader::LinkProgram(_programID);
    GLint status;
